<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="thanhly_moi.aspx.cs" Inherits="ProOnline.quanly.thanhly_moi" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function luuThongTin() {
            if (ProOnline.quanly.thanhly_moi.checkDuyetQToan(document.getElementById("ctl00_ContentPlaceHolder1_hdfSttDA").value).value == "1") {
            ...
            var ktNgay = ProOnline.quanly.thanhly_moi.kiemTraNgay(param[5]);
            ...
            if (param[12] != "") {
                var ktNgay = ProOnline.quanly.thanhly_moi.kiemTraNgay(param[12]);
                if (ktNgay.value == false) {
            ...
            var result = ProOnline.quanly.thanhly_moi.luuThongTin(param, coThaoTac);
            if (result.value == "0") {
        ...
        function loadDanhSachCongViec(a, b, c) {
            debugger;
            var result = ProOnline.quanly.thanhly_moi.getDanhSachCongViec(a, b, c);
        ...
        function changeCongViec() {
            var result = ProOnline.quanly.thanhly_moi.thongTinCongViec(cboCongViec.value(), coThaoTac);
        ...
        function xoaThongTinTL() {
            ...
            if (Grid1.SelectedRecords.length > 0) {
                ...
                if (ProOnline.quanly.thanhly_moi.checkDuyetQT(record.sttDuAnpr_sd).value == "1") {
        ...
        function openWindows() {
            ...
            var kq = ProOnline.quanly.thanhly_moi.xuatWord(document.getElementById("ctl00_ContentPlaceHolder1_hdfSttTL").value).value;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="thongTinThanhLyCT" style="display: none"><!-- id=thongTinThanhLyCT -->
                                                            ...
                                                            <td colspan="8">
                                                                <script type="text/javascript">
                                                                    ...
                                                                    function chonHopDong() {
                                                                        var result = ProOnline.quanly.thanhly_moi.getThongTinThanhToan(cboHopDong.value(), document.getElementById("ctl00_ContentPlaceHolder1_hdfSttDuAnpr_uc").value);
                                                                        if (result.value.Rows.length > 0) {
                                                                            //debugger;
                                                ...
                                                <fieldset style="border: 1px solid #DBDBE1; margin-left: 0px; margin: 3px; padding: 4px">
                                                    ...
                                                    <script type="text/javascript">
                                                        ...
                                                        function luuThanhLyCT(record) {
                                                            ...
                                                            if (ProOnline.quanly.thanhly_moi.soSanh(param[6], eGiaTriHD.value()).value == true) {
                                                                alert("Đơn giá không được lớn hơn giá trị hợp đồng");
                                                                return false;
                                                            }
                                                            if (ProOnline.quanly.thanhly_moi.soSanh(param[7], eGiaTriHD.value()).value == true) {
                                                                alert("Thành tiền không được lớn hơn giá trị hợp đồng");
                                                                return false;
                                                            }
                                                            var result = ProOnline.quanly.thanhly_moi.kiemTraCongViecThanhLy(cboCongViec.value(), sttTLCT);
                                                            if (result.value != "") {
                                                                alert("Công việc đã được thanh lý");
                                                                return false;
                                                            }
                                                            var result = ProOnline.quanly.thanhly_moi.luuThongTinThanhLyCT(param, coThaoTac);
                                                            if (result.value == "0") {
                                                        ...
                                                        function eDonGia_OnTextChanged() {
                                                            debugger;
                                                            var result = ProOnline.quanly.thanhly_moi.thanhTien(eKhoiLuong.value(), eDonGia.value());
        ...
        <script type="text/javascript">
            ...
            function xoaThanhLy() {
                debugger;
                var result = ProOnline.quanly.thanhly_moi.xoaThongTin(sttXoa, coThaoTac);
                if (result.value == "0") {
        ...
        <script type="text/javascript">
            ...
            function uploadComplete(sender, args) {
                ...
                var ketqua = ProOnline.quanly.thanhly_moi.layThongTinVanBanTL(document.getElementById("ctl00_ContentPlaceHolder1_hdfSttTL").value);
            ...
            function truocKhiXoa(record) {
                ...
                if (ProOnline.quanly.thanhly_moi.checkDuyetQToan(document.getElementById("ctl00_ContentPlaceHolder1_hdfSttDuAnpr_uc").value).value == "1") {
                    alert("Dự án đã được duyệt quyết toán, bạn không thể thực hiện thao tác này!");
                    return false;
                }
                coThaoTac = "1";
    ...
    <script type="text/javascript">
        function loadHopDong() {
            debugger;
            //var result = ProOnline.quanly.thanhly_moi.getDanhSachHopDong(document.getElementById("ctl00_ContentPlaceHolder1_hdfSttDA").value);
            var result = ProOnline.quanly.thanhly_moi.getDanhSachHopDong(document.getElementById("ctl00_ContentPlaceHolder1_hdfSttDuAnpr_uc").value);
            cboHopDong.options.clear();
            for (var i = 0; i < result.value.Rows.length; i++) {
                var noiDung = result.value.Rows[i].noidung;
    ...
    <script type="text/javascript">
        jQuery(function ($) {
            ...
            .on('actionclicked.fu.wizard', function (e, info) {
                ...
                if (!tmp_click && info.step == 2) {
                    if (document.getElementById("ctl00_ContentPlaceHolder1_hdfSttDuAnpr_uc").value == "" || document.getElementById("ctl00_ContentPlaceHolder1_hdfSttDuAnpr_uc").value == "0") {
                        ...
                        var ktNgay = ProOnline.quanly.thanhly_moi.kiemTraNgay(param[4]);
                        if (ktNgay.value == false) {
            ...
            .on('finished.fu.wizard', function (e) {
                ...
                var ketqua_luuvb = ProOnline.quanly.thanhly_moi.luuThongTinVanBanTL(param).value;
