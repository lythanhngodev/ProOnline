            ...
            if (tabCauHinh.Rows.Count != 0)
            {
                ...
                foreach (DataRow drCauHinh in tabCauHinh.Rows)
                {
                    if (drCauHinh["label"].ToString().ToUpper() == "TRONGDO")
                    {
                        ...
                        dtView.RowFilter = stringWhere == "" ? "" : stringWhere + " and " + drCauHinh["stringWhere"].ToString().ToUpper();
                    ...
                    {
                        stringWhereNhom2 = stringWhereNhom1 == "" ? "" : (stringWhereNhom1 + " and " + drCauHinh["stringWhere"].ToString());
                    ...
                    {
                        stringWhereNhom3 = stringWhereNhom2 == "" ? "" : (stringWhereNhom2 + " and " + drCauHinh["stringWhere"].ToString());
                    ...
                    {
                        stringWhereNhom4 = stringWhereNhom3 == "" ? "" : (stringWhereNhom3 + " and " + drCauHinh["stringWhere"].ToString());
                    ...
                    {
                        stringWhereNhom5 = stringWhereNhom4 == "" ? "" : (stringWhereNhom4 + " and " + drCauHinh["stringWhere"].ToString());
